                ...
                {modelCatalog.length === 0 ? (
                  <div className="col-span-full grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                    {[1, 2, 3, 4, 5, 6].map((i) => (
                      <div
                        key={i}
                        className="p-5 bg-black/40 border border-zinc-900 rounded-2xl relative overflow-hidden flex flex-col gap-4"
                      >
                        <div className="flex items-start justify-between">
                          <div className="space-y-2 flex-1">
                            ...
                            <div className="flex items-center gap-2">
                              <div className="h-4 w-16 bg-zinc-900 rounded-md animate-pulse" />
                              <div className="h-3 w-28 bg-zinc-900/60 rounded animate-pulse" />
                            </div>
                          </div>
                          <div className="flex flex-col items-end gap-1">
                            <div className="h-4 w-14 bg-zinc-800/80 rounded animate-pulse" />
                            <div className="h-2 w-10 bg-zinc-900 rounded animate-pulse" />
                          </div>
                        </div>
                        <div className="h-8 w-full bg-zinc-900/40 rounded-xl border border-zinc-850/60 flex items-center justify-between px-3">
                          <div className="h-2 w-20 bg-zinc-800 rounded animate-pulse" />
                          <div className="h-4 w-10 bg-zinc-800/80 rounded-full animate-pulse" />
                        </div>
                      </div>
                    ))}
                    <div className="col-span-full text-center py-2 text-zinc-600 font-mono text-[10px] uppercase tracking-widest flex items-center justify-center gap-2">
                      <RefreshCw size={10} className="animate-spin text-cyan-500/70" />
                      Streaming dynamic neural models catalog...
                    </div>
                  </div>
                ) : (
                  (() => {
