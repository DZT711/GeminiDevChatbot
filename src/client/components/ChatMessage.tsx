...
import { User, Bot, Terminal, Pencil, Check, X, FileText, Link as LinkIcon, Copy, History, RotateCcw, ChevronDown, ChevronUp, Eye, AlertTriangle, ThumbsUp, ThumbsDown } from 'lucide-react';
